...
800px;height:auto;padding: 10px" >
...
<table id="dg" title="客户订单展示" class="easyui-datagrid" fitColumns="true" pagination="true" rownumbers="true"
       url="${ctx}/customer_order/list?cusId=${customer.id}" toolbar="#tb" style="width:800px;height: auto;" singleSelect="true">
    <thead>
    <tr>
...
<div id="dlg" class="easyui-dialog" style="width:750px;height:400px" resizable="true" closed="true">
    <div id="p" class="easyui-panel" title="订单信息" style="width:700px;height:auto">
        <form id="fm" method="post">
            <table cellspacing="8px">
                <tr>
                    <td>订单编号：</td>
                    <td><input type="text" name="orderNo" readonly="readonly"/></td>
                    <td></td>
                    <td>支付状态</td>
    ...
    <table id="dg02" title="商品列表" class="easyui-datagrid" fitColumns="true" pagination="true" rownumbers="true"
           url="${ctx}/order_details/list" toolbar="#tb02" style="width:700px;height: auto;" >
        <thead>
        <tr>
            <th field="cb" checkbox="true" align="center"></th>
            <th field="id" width="50" align="center">编号</th>
            <th field="orderId" width="100" align="center">订单id</th>
            <th field="goodsName" width="80" align="center">商品名称</th>
            <th field="goodsNum" width="80" align="center" >商品数量</th>
