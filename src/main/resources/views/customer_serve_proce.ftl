...
<table id="dg"  class="easyui-datagrid"
       ...
       url="${ctx}/customer_serve/list?state=fw_003&flag=1" fit="true" toolbar="#tb" singleSelect="true" singleSelect="true">
    <thead>
    <tr>
...
<div id="dlg-buttons">
    <a href="javascript:addAssign()" class="easyui-linkbutton" iconCls="icon-ok">处理</a>
