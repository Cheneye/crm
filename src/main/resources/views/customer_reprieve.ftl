...
<head>
    ...
    <script type="text/javascript" src="${ctx}/static/js/customer.reprieve.js"></script>
</head>
...
<table id="dg" title="暂缓设置列表" class="easyui-edatagrid" fitColumns="true" pagination="true" rownumbers="true"
toolbar="#toolbar" style="width:800px;height: auto;" singleSelect="true">
<thead>
<tr>
