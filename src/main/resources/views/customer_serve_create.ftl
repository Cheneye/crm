...
<div id="p" class="easyui-panel" title="客服信息创建" style="width:700px;height: auto;padding: 10px" fit="true">
    <form id="fm" method="post">
        <table cellspacing="8px">
            <tr>
                ...
                <td>服务类型：</td>
                <td>
                    <select id="serveType" class="easyui-combobox" name="serveType" style="width:174px;" panelHeight="auto">
