...
<table id="dg" class="easyui-datagrid"
    ...
    <tr>
        ...
        <th field="customer" width="80" align="center">客户名</th>
        <th field="serveType" width="50" align="center" formatter="formatterServeType">服务类型</th>
        <th field="overview" width="80" align="center">概要信息</th>
        <th field="serviceRequest" width="80" align="center">请求内容</th>
        <th field="assignTime" width="80" align="center">分配时间</th>
        <th field="createPeople" width="50" align="center">创建人</th>
        <th field="serviceProcePeople" width="50" align="center">处理人</th>
        <th field="serviceProce" width="80" align="center">处理内容</th>
        <th field="serviceProceTime" width="100" align="center">处理时间</th>
