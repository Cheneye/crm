...
<div id="tb">
    <div>
        ...
        <a href="javascript:openCustomerLinkman()" class="easyui-linkbutton" iconCls="icon-remove" plain="true">联系人管理</a>
        <a href="javascript:deleteCustomer()" class="easyui-linkbutton" iconCls="icon-remove" plain="true">交往记录</a>
        <a href="javascript:openCustomerOrderTab()" class="easyui-linkbutton" iconCls="icon-remove" plain="true">订单查看</a>
    </div>
    <div>
