...
<table id="dg"  class="easyui-datagrid"
       ...
       url="${ctx}/customer_serve/list?state=fw_004" fit="true" toolbar="#tb" singleSelect="true" singleSelect="true">
    <thead>
    <tr>
...
<div id="dlg" class="easyui-dialog" style="width:650px;height:400px;padding: 10px 20px"
